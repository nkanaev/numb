...
var units = []unitDef{
	...
	{u: d.MASS, name: "g", long: "gram", value: r.Must("0.001"), prefixes: &metricPrefixes},
	...
	{u: d.TEMPERATURE, name: "°C, degC", long: "celsius", value: r.ONE, offset: r.Must("273.15")},
	{u: d.TEMPERATURE, name: "°F, degF", long: "fahrenheit", value: r.Must("10/18"), offset: r.Must("459.67")},
	{u: d.ANGLE, name: "rad", long: "radian", value: r.ONE},
	{u: d.DIGITAL, name: "bit", long: "bit", value: r.ONE, prefixes: &digitalPrefixes},
	{u: d.DIGITAL, name: "B", long: "byte", value: r.Must("8"), prefixes: &digitalPrefixes},
	...
	{u: d.VOLUME, name: "l, lt, L", long: "liter, litre", value: r.Must("0.001"), prefixes: &metricPrefixes},
	{u: d.ENERGY, name: "J", long: "joule", value: r.ONE, prefixes: &metricPrefixes},
	{u: d.ENERGY, name: "Wh", long: "watt-hour", value: r.Must("3600"), prefixes: &metricPrefixes},
	{u: d.ENERGY, name: "eV", long: "electronvolt", value: r.Must("1.602176565e-19"), prefixes: &metricPrefixes},
	...
	{u: d.PRESSURE, name: "bar", long: "bar", value: r.Must("100000"), prefixes: &metricPrefixes},
